...
private:
    ...
    [[nodiscard]] PTRef legacy(PTRef invariant, unsigned k, TransitionSystem const & system) const;
    [[nodiscard]] PTRef unfold(PTRef invariant, unsigned k, TransitionSystem const & system) const;
