...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "596501bab9008a69ea20f499911e7c751fe0f29e"
  WORKING_DIRECTORY "/home/mambo/golem/cmake-build-release/_deps/opensmt-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "596501bab9008a69ea20f499911e7c751fe0f29e")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("596501bab9008a69ea20f499911e7c751fe0f29e" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/596501bab9008a69ea20f499911e7c751fe0f29e")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/mambo/golem/cmake-build-release/_deps/opensmt-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/mambo/golem/cmake-build-release/_deps/opensmt-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
